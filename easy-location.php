...
if (!function_exists('easy_location_handle_edit_post')) :
	function easy_location_handle_edit_post($post_id)
	{
		$onlineip = '';
		...
		if (!$onlineip) return;
		update_post_meta($post_id, 'easy_location_ip', $onlineip);
	}
endif;
...
add_filter('the_content', 'easy_location_handle_post_content');
add_action('save_post', 'easy_location_handle_edit_post');
